        ...
        <div class="container mx-auto p-4">
            ...
            <div class="flex justify-between items-center">
                <div class="flex w-full gap-2">
                    ...
                    <form method="GET" action="{{ route('manager.create2') }}" class="flex items-center gap-2 mb-4">
                        <input 
                            type="month" 
                            name="periode" 
                ...
                <table class="min-w-full bg-white border border-gray-200 rounded shadow">
                    ...
                    <tbody id="kodeTable">
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-2 border whitespace-nowrap">{{ $item->status }}</td>
                            <td class="p-2 border text-center">
                                <!-- Tombol Edit -->
                                <div class="flex gap-2">
                                    <a href="{{ route('manager.edit2', $item->id) }}" class="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600">
                                    ...
                                    <a href="{{ route('manager.edit22', $item->id) }}" class="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600">
